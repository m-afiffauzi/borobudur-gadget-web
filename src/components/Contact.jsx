              ...
              {btn.map((item, index) => {
                ...
                return (
                  <a key={index} href={href} rel="noreferrer" target="_blank">
                    <button
                      className="bg-white btn btn-sm rounded-sm group [transform:translateZ(0)] w-32 py-3 overflow-hidden relative before:absolute before:bg-primary-200 before:bottom-0 before:left-0 before:h-full before:w-full before:rounded-sm before:origin-[100%_100%] before:scale-x-0 hover:before:origin-[0_0] hover:before:scale-x-100 before:transition before:ease-in-out before:duration-300"
                      data-aos="fade-down"
                      data-aos-delay="700"
                    >
